        ...
        <>
                ...
                <form>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" id="username" className="w-full bg-gray-700 text-white rounded px-3 py-2" />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" id="confirmPassword" className="w-full bg-gray-700 text-white rounded px-3 py-2" />
                    </div>
